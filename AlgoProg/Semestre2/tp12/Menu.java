...
public class Menu  {
    ...
    private Map<String, Entree> raccourcis;
    ...
    public Menu(String sonTitre) {
        ...
        this.raccourcis = new HashMap<String, Entree>();
	    this.titre = sonTitre;
	    this.selection = null;
    ...
    public void ajouter(String texte, Commande cmd, String raccourci) {
        ajouter(texte, cmd)
        raccourcis.put(raccourci, entrees.size()-1);
    }
    ...
    public void selectionner() {
	    ...
	    do {
	        String lecture = Console.readLine("Votre choix : ");
            if (raccourci.contains(lecture)) {
                choix = raccourci.get(lecture);
            } else {
