...
public class EditeurLigne {
    ...
    public EditeurLigne(Ligne l) {
	    ...
	    menuPrincipal.ajouter("Remettre le curseur en debut de ligne", new CommandeCurseurRAZ(ligne));
	    menuPrincipal.ajouter("Supprimer le caractere courant", new CommandeSupprimerSous(ligne));
    }
