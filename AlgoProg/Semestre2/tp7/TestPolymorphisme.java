...
public class TestPolymorphisme {
	...
	public static void main(String[] args) {
		...
		System.out.print ("q = "); q.afficher(); System.out.println ();
										// Qu'est ce qui est affiché ? cf p1

		// Attacher un point nommé à q et l'afficher
		q = pn1;			// Est-ce autorisé ? Pourquoi ? Oui PointNomme C Point
		...
		// Attacher un point à q et l'afficher
		qn = p1;			// Est-ce autorisé ? Pourquoi ? Non, pas assez d'infos
		...
		System.out.print ("qn = "); qn.afficher(); System.out.println ();
										// Qu'est ce qui est affiché ? cf pn1

		double d1 = p1.distance (pn1);	// Est-ce autorisé ? Pourquoi ? Oui, PointNomme C Point
		...
		qn = q;				// Est-ce autorisé ? Pourquoi ? Non, probleme de typage apparent
		System.out.print ("qn = "); qn.afficher(); System.out.println ();
										// Qu'est ce qui est affiché ?
		...
		qn = (PointNomme) p1;		// Est-ce autorisé ? Pourquoi ? Oui, mais ne marchera pas a l'execution
		System.out.print ("qn = "); qn.afficher(); System.out.println ();
	}
